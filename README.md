...
An assistive learning application for children with Auditory Processing Disorder (APD) made in Android. The application provides an assistive reading tool, comprehension exercises and data analytics to analyze a user's progress.
...
![image](https://github.com/user-attachments/assets/f82145c4-c96e-4f18-8d1e-090e560928a2)

From left to right, the Home, Practice, Camera, Analytics and Profile Fragments:

![image](https://github.com/user-attachments/assets/5e010709-ff37-41df-b18b-5be31dc429f2)

The left image displays the RenderedText fragment highlighting parts of speech. The right image displays the Quiz fragment where the user is performing a noun quiz:

![image](https://github.com/user-attachments/assets/c89485dd-e9c3-4388-be47-65423c6a6993)

A user’s data breakdown presented in the application:

![image](https://github.com/user-attachments/assets/accf8616-0ba9-4a3b-8206-7c3eb08b53a4)



## Project Report

For a full breakdown of the project view the .pdf below:

[Capstone Project Report - Clearer.pdf](https://github.com/user-attachments/files/19494767/Capstone.Project.Report.-.Clearer.pdf)
